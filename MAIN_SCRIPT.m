...
if alpha < 0.5 && alpha >=0
   ...
   [X_intercept_upper,yu] = intersection_function(domain,range,xx,yy,robust);
    ...
    hold on
     ...
     text(X_intercept_upper(1), yu(1) , sprintf('  \\leftarrow  %f, %f', X_intercept_upper(1), yu(1)))
      text(X_intercept_lower(1), ydn(1) +0.005 , sprintf('  \\leftarrow  %f, %f', X_intercept_lower(1), ydn(1)))
